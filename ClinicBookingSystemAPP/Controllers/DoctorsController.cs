...
namespace ClinicBookingSystemAPP.Controllers
{
    public class DoctorsController : Controller
    {
        ...
        {
            var clinicDbContext = _context.Doctors.Include(d => d.Department);
        ...
        public async Task<IActionResult> Create([Bind("Id,FullName,specialization,Email,Phone,DepartmentId")] Doctor doctor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FullName,specialization,Email,Phone,DepartmentId")] Doctor doctor)
        {
            if (id != doctor.Id)
            {
                return NotFound();
